...
**Documentation search tools:** use available docs tools / web search — whichever is available in your environment.
...
search(query="React Query setup")
...
Create `epmp-docs/research-logs/{feature_name}.md` with:
...
Then create an ADR using the **ADR Skill** at `epmp-docs/adr/NNNN-short-title.md`.
...
- [ ] Research log created at `epmp-docs/research-logs/{feature_name}.md`
