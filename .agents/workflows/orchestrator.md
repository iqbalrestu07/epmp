...
- Search external documentation for each technology (use available docs tools / web search)
- Document findings in `epmp-docs/research-logs/{feature}.md`
...
**File:** `3-integrate.md`
**Mandatory Rules:** `testing-strategy.md`, `error-handling-principles.md`

- Integration tests via `internal/testutil` against local PostgreSQL
...
| ----------------- | ------------------------------------------ | ------------------- |
| Research          | `task.md` + `epmp-docs/research-logs/*.md` | Yes                 |
