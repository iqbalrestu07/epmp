...
Load supplementary rules when reaching Level 2 (not applicable to this project — Docker Compose only).
...
**Kubernetes:**
Use GitOps with ArgoCD or FluxCD (Level 2 — not applicable to this project).
...
> PRD or technical architecture document.
