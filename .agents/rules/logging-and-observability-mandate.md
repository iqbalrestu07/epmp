...
Observability is built on **three pillars** — this mandate governs Logs.

1. **Logs** — *What happened* (events, errors, state changes) — governed by this file
2. **Metrics** — *How much / how many* (quantitative measurements) — platform-level concern
3. **Traces** — *How did it happen* (request flow through system) — platform-level concern
