...
**Save to:** `epmp-docs/debugging/{issue-name}-{YYYY-MM-DD}-{HHmm}.md`

1. Create `epmp-docs/debugging/` if it doesn't exist
...
| [Frontend](languages/frontend.md) | React, browser, Vite       |
