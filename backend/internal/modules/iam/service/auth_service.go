...
// The user starts with no roles and no organization.
// They must create or join an organization separately after registration.
func (s *AuthService) Register(ctx context.Context, req *dto.RegisterRequest) (*dto.TokenResponse, error) {
	...
	user := &entity.User{
		ID:           uid.New(), // ULID generated by application, not DB
		Email:        req.Email,
	...
	// No roles assigned at registration.
	// User must create or join an Organization to get operational access.
