  ...
  return (
    <div className="space-y-6">
      ...
      <dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        ...
        <div className="space-y-1">
          <dt className="text-xs font-semibold text-slate-500 uppercase tracking-wider">PenaltyDate</dt>
          <dd className="text-sm text-slate-800 mt-1">{String(data.penalty_date ?? "—")}</dd>
        </div>
        <div className="space-y-1">
