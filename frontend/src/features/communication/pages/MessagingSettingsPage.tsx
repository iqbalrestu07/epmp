    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-orange text-black px-4 py-2 rounded-lg font-medium hover:bg-orange/90"
        >
          Add WhatsApp Device
        </button>
      </div>
      ...
      {showQR && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
          <div className="bg-white p-8 rounded-2xl w-full max-w-md text-center shadow-xl">
            ...
            <div className="bg-gray-100 w-64 h-64 mx-auto rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 mb-6">
              <span className="text-gray-400">Loading QR... (Backend Stub)</span>
            </div>
