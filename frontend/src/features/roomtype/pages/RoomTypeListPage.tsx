...
import { useRoomTypes, useDeleteRoomType } from "../hooks";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900">RoomTypes</h1>
      ...
      {isLoading ? (
        <div className="text-center py-12 text-slate-400">Loading roomtypes...</div>
      ) : (
        <>
          <RoomTypeTable data={data?.data ?? []} onRowClick={handleRowClick} />
