  ...
  return (
    <div className="space-y-6">
      ...
      <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-1">
          <dt className="text-sm font-medium text-gray-500">InspectionDate</dt>
          <dd className="text-sm">{String(data.inspection_date ?? "—")}</dd>
        </div>
        <div className="space-y-1">
          <dt className="text-sm font-medium text-gray-500">Condition</dt>
          <dd className="text-sm">{String(data.condition ?? "—")}</dd>
        </div>
        <div className="space-y-1">
