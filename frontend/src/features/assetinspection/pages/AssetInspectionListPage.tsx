...
export function AssetInspectionListPage() {
  ...
  const { data, isLoading } = useAssetInspections({
    page,
    per_page: 20,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900">AssetInspections</h1>
      ...
      <form onSubmit={handleSearch} className="flex gap-2">
        <Input
          placeholder="Search assetinspections..."
          value={searchInput}
      ...
      {isLoading ? (
        <div className="text-center py-12 text-slate-400">Loading assetinspections...</div>
      ) : (
        <>
          <AssetInspectionTable data={data?.data ?? []} onRowClick={handleRowClick} />
