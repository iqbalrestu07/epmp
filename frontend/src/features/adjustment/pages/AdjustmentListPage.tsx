...
export function AdjustmentListPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-1">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">Adjustments</span>
          </div>
      ...
      {isLoading ? (
        <div className="text-center py-12 text-slate-400">Loading adjustments...</div>
      ) : (
        <>
          <AdjustmentTable data={data?.data ?? []} onRowClick={handleRowClick} />
