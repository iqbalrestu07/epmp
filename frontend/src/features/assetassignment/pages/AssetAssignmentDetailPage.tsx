    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => navigate("/dashboard/asset-assignments")}>
            Back
          </Button>
          <Button variant="outline" onClick={() => navigate(`/dashboard/asset-assignments/${id}/edit`)}>
            Edit
          </Button>
      ...
      <dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        ...
        <div className="space-y-1">
          <dt className="text-xs font-semibold text-slate-500 uppercase tracking-wider">AssignedDate</dt>
          <dd className="text-sm text-slate-800 mt-1">{String(data.assigned_date ?? "—")}</dd>
        </div>
      </dl>
    </div>
  );
