  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-sm text-black/40">
        ...
        <ChevronRight size={14} />
        <span className="text-black/60">{asset.name}</span>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-black/5 p-6 space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          <div>
            <h3 className="text-sm font-medium text-black/50 mb-1">Status</h3>
            <p className="font-medium">{asset.status}</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-black/50 mb-1">Category</h3>
            <p className="font-medium">{asset.category}</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-black/50 mb-1">Purchase Price</h3>
