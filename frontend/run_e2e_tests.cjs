...
const PAGES_TO_TEST = [
  ...
  '/dashboard/occupancies/new',
  '/dashboard/invoices',
  '/dashboard/invoices/new',
  '/dashboard/payments',
  '/dashboard/payments/new',
  '/dashboard/deposits',
  '/dashboard/deposits/new',
  '/dashboard/charges',
  '/dashboard/charges/new',
  '/dashboard/refunds',
  '/dashboard/refunds/new',
  '/dashboard/adjustments',
  '/dashboard/adjustments/new',
  '/dashboard/penalties',
  '/dashboard/penalties/new',
  '/dashboard/assets',
  '/dashboard/assets/new',
  '/dashboard/asset-assignments',
  '/dashboard/asset-assignments/new',
  '/dashboard/asset-inspections',
  '/dashboard/asset-inspections/new',
